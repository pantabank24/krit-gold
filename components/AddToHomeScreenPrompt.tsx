...
const AddToHomeScreenPrompt: React.FC = () => {
  ...
  if (isIos && !isInStandaloneMode) {
    return (
      <div
        className={` fixed top-16 z-40 px-2 pt-2 flex justify-center w-full  ${isClosing
            ? "opacity-0 scale-95"
            : isOpening
        ...
        <div className="backdrop-blur-xl border border-white/20 bg-white/10 rounded-xl p-4 shadow-md flex flex-col items-center">
          <div className=" flex flex-row w-full gap-x-2 items-center text-sm">
            ...
            <span className=" font-semibold mr-4">
              เพิ่ม หลอมทองพัทยา By กฤต เมืองตาก ลงหน้าจอหลักบน iOS: กด{" "}
      ...
      >
        <div className="backdrop-blur-xl border border-white/20 bg-white/10 rounded-xl p-4 shadow-md flex flex-col items-center">
          <div className=" flex flex-row w-full gap-x-2 items-center text-sm">
            ...
            <span className=" font-semibold mr-4">
              เพิ่ม หลอมทองพัทยา By กฤต เมืองตาก ลงหน้าจอหลักเพื่อเข้าใช้งานสะดวกยิ่งขึ้น!
            </span>
          </div>
