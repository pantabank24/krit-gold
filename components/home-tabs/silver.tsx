    ...
    <section className="flex flex-col  gap-4 transition-all duration-300 ">
      ...
      <div>
        ...
        <div className=" flex flex-col mx-4 items-center">
          {error ? (
            <div className=" px-10 flex flex-row mt-3 h-40 w-full max-w-96 border-2 border-yellow-600 bg-gradient-to-b from-orange-950 to-[#510001] rounded-2xl justify-center items-center">
            ...
            <div className=" grid grid-cols-2  lg:grid-cols-5 gap-x-4 gap-y-2 items-start justify-center">
              ...
              <div className=" col-span-2 flex flex-col h-full gap-y-4 w-full items-center">
                <div className=" flex w-full text-center flex-col justify-center rounded-3xl py-2 px-5 backdrop-blur-xl border border-yellow-300/20 bg-gradient-to-b from-white/5 to-[#510001]   ">
                  <span className=" font-bold text-2xl bg-gradient-to-b from-white to-white/40 bg-clip-text text-transparent mb-1  ">
                    แท่งเงิน 99.99%
                  </span>
                  <div className=" grid grid-cols-2  gap-x-4">
                    <div className="backdrop-blur-xl border border-white/20 bg-gradient-to-b from-black/90 to-[#510001] flex flex-col items-center py-5 rounded-2xl h-20 justify-center">
                      {isLoading ? (
                        <CircularProgress
                          aria-label="Loading..."
                          color="warning"
              ...
              <div className=" col-span-2 flex flex-col w-full justify backdrop-blur-xl border border-white/20 bg-gradient-to-b from-white/5 to-[#510001] px-3 py-4 rounded-3xl ">
