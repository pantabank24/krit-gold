        ...
        <ModalContent>
          {(onClose) => (
            <>
              ...
              <ModalBody>
                <div className=" flex flex-row gap-x-4 overflow-x-scroll scrollbar-hide bg-gradient-to-b from-white/10 to-[#510001] border-1 rounded-3xl p-2 border-white/20">
                  <img
