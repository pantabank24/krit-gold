...
export default function ECommerce() {
  ...
  return (
    <div className=" flex flex-col gap-y-4 px-4 w-full lg:w-1/2 h-full">
        ...
        <div className=" flex flex-row gap-x-2 ">
          {menu.map((v, i) => (
            <div
              ...
              className={`cursor-pointer border border-white/20 bg-gradient-to-b ${v?.path == path ? "bg-[#710711]" : " from-white/10 to-[#510001]"}  rounded-xl py-5 w-32 items-center justify-center flex flex-col text-yellow-100`}
            >
              {v.icon}
              {v.name}
            </div>
      ...
      <div className=" flex flex-col gap-y-2">
        <span>ข่าวสาร</span>
        <div className="border border-white/20 bg-gradient-to-b from-white/10 to-[#510001] flex w-full  h-96 rounded-2xl items-center justify-center flex-col">
          <CodeXml size={50} />
