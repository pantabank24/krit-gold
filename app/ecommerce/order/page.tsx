          ...
          {menu.map((v, i) => (
            ...
            >
              <div
                ...
                className={`flex flex-col items-center justify-center gap-y-1 ${menuSelected === v.key ? " border rounded-2xl border-white/20 bg-gradient-to-b from-white/10 to-[#510001]" : ""} h-16 px-4 lg:px-6`}
              >
                <div>{v.icon}</div>
        ...
        <div className=" flex h-full w-full">
          <div className="flex w-full flex-col gap-y-4 mt-5 h-full overflow-scroll scrollbar-hide pb-44 rounded-2xl">
            {selectList.map((v, i) => (
              <div
                key={i}
                className=" flex flex-col border-white/20 bg-gradient-to-b from-white/10 to-[#510001] border-1 px-4 py-2 rounded-2xl"
              >
